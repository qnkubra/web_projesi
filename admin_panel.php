...
<head>
    ...
    <style>
        ...
        .search-box:focus {
            border-color: #b89c88;
            box-shadow: 0 0 10px rgba(184, 156, 136, 0.2);
        }
...
<body>
    ...
    <div class="container">
        ...
        <div class="header-container">
            ...
            <input type="text" id="aramaKutusu" class="search-box" placeholder="Öğrenci Adı, E-posta veya Masa Kodu (Örn: A5) Ara...">
        </div>
    ...
    <script>
        document.getElementById('aramaKutusu').addEventListener('keyup', function() {
            let arananDeger = this.value.toLowerCase();
            let tabloSatirlari = document.querySelectorAll('.veri-satiri');

            tabloSatirlari.forEach(function(satir) {
                // Satırın içindeki tüm metni al (Öğrenci adı, masa kodu, salon vs.)
                let satirMetni = satir.textContent.toLowerCase();

                // Eğer aranan kelime bu satırda geçiyorsa göster, geçmiyorsa gizle
